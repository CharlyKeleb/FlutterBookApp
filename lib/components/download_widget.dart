...
import 'package:flutter_book_app/components/custom_alert.dart';
    ...
    await dio.download(
      ...
      onReceiveProgress: (receivedBytes, totalBytes) {
        ...
        if (receivedBytes == totalBytes) {
          Navigator.pop(context, '${Constant.formatBytes(total, 1)}');
        }
      },
    );
  }
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      '${Constant.formatBytes(received, 1)} '
                      'of ${Constant.formatBytes(total, 1)}',
                      style: TextStyle(
                        fontSize: 13.0,
                      ),
                      maxLines: 2,
